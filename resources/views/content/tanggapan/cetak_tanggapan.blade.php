...
<hr>
<h3><center>Laporan Data Tanggapan</center></h3>
<table border="1" cellspacing="0" cellpadding="5">
  ...
  @foreach($data_tanggapan as $s) 
                                 @php
                                     $nama_siswa=App\Models\User::Select('nama')->where('id','=',$s->id_siswa)->get();
                                 @endphp  
  <tr>
    <td>{{$s->id}}</td>
